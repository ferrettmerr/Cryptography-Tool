...
class MainWindow(wx.Frame):
    ...
    def set_to_affine(self):
        ...
        a = wx.ComboBox(self.panel, -1, pos=(self.width/2 - 86, 50), size=(75, -1), choices=aValues, style=wx.CB_READONLY)
        b = wx.ComboBox(self.panel, -1, pos=(self.width/2 + 14, 50), size=(75, -1), choices=bValues, style=wx.CB_READONLY)
